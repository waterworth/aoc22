...
function findTop3Elves(elves: number[][]) {
  ...
  return getCalorieCount(elves.sort().slice(elves.length - 4, elves.length - 1).flat())
...
/**
 * This is going to be using the .txt file because i shouldnt have wasted time doing that data
